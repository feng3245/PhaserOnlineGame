...
RPG.Door.prototype.interact = function(){
    "use strict";
    this.game_state.game.state.start("BootState", false, false, this.next_level, "WorldState", {});
}
/*RPG.Door.prototype.update = function () {
    "use strict";
    this.game_state.game.physics.arcade.overlap(this, this.game_state.groups.players, this.enter, null, this);
};
