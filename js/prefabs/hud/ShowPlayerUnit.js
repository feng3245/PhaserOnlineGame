...
RPG.ShowPlayerUnit = function (game_state, name, position, properties) {
    ...
    this.player_unit_mana = new RPG.ShowStatWithBar(this.game_state, this.name + "_health", {x: this.x, y: this.y + 30}, {group: "hud", text: "MP", style: properties.text_style, prefab: properties.prefab, stat: "mana", bar_texture: "manabar_image"});
...
RPG.ShowPlayerUnit.prototype.change_current_unit = function (new_prefab, new_face_texture) {
    "use strict";
    this.unit_data = this.game_state.game.party_data[new_prefab];
